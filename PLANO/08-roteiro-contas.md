...
## Passo 1 — Change.org (a petição) 🔴 prioridade máxima
1. Criar conta com o e-mail do movimento.
...
- Precisa de CPF. É o **único custo do movimento**.
- Não precisa configurar nada agora — o chip do GitHub Pages faz a ligação.
