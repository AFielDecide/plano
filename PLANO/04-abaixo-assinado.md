# ABAIXO-ASSINADO — "A FIEL QUER VOTAR"
*Texto pronto pra publicar (recomendado: Change.org como principal + espelhar a contagem no site). Sem validade jurídica — o valor é político: é o mandato da massa, público e inegável.*
...
**IMAGEM:** `ARTES\capa-peticao-FINAL.png` (12/08/2026) — foto P&B do torcedor erguendo o cartão "A FIEL DECIDE", tarja com a manchete. Escudo oficial removido da arte; **nunca usar o escudo**, pra evitar litígio de marca.

**TEXTO PRONTO PRA COLAR:** `PLANO\04-COLAR-NO-CHANGE.txt` (texto puro — o Change.org não renderiza markdown; asterisco vira asterisco na tela). O que segue abaixo é a versão canônica comentada.

**DIRIGIDO A:** Conselho Deliberativo, Conselho de Orientação (CORI) e Presidência do Sport Club Corinthians Paulista.

---

### O texto (v2, 12/08/2026 — abertura narrativa)

> Abertura em técnica de conto (cena concreta, personagem sem nome, categoria antes de indivíduo, fecho em fato seco). **Retrato coletivo assumido, não testemunho** — a linha "Você conhece esse homem" existe pra deixar isso explícito ao leitor. Zero fato inventado: 1983, a faixa do Morumbi, a dívida, os ~4 mil votantes e o Parque São Jorge como garantia são todos verificáveis.
...
4. Espelhar a contagem no site com prova social ("já somos X mil").
